...
public class GestionImmeuble {
    ...
    public static void main(String[] args) {
        ...
        boolean demandeLogement = true; //variable pour montrer ou cacher la question qui demande le numero de logement
